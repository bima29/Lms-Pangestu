...
import { Users, Plus, Search, Edit, Trash2, Eye, EyeOff, X, Save, Phone, Building, ChevronLeft, ChevronRight } from 'lucide-react';
                ...
                <tr key={user.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap hidden lg:table-cell">
                    <div className="flex items-center text-sm text-gray-500">
                      ...
                      {user.school_id ? mockSchools.find(s => s.id === user.school_id)?.name || 'Sekolah tidak ditemukan' : 'Belum ditentukan'}
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-600 truncate">
                  {mockSchools.find(s => s.id === user.school_id)?.name || 'N/A'}
                </span>
              </div>
      ...
      {filteredUsers.length > 0 && (
        <div className="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6 rounded-lg shadow mt-4">
            ...
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              ...
              <div className="flex items-center space-x-2">
                <div className="flex items-center space-x-2">
                  <label className="text-sm text-gray-700">Tampilkan {itemsPerPage} item per halaman:</label>
                  <select
                    value={itemsPerPage}
                    onChange={(e) => {
